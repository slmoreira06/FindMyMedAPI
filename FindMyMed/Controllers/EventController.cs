...
namespace FindMyMed.Controllers
{
    ...
    public class EventController : Controller
    {
        ...
        /// <summary>
        /// Show the event in Calendar of an Acount. Deploy an error 404() if Account doesnt correspond to a event.
        /// </summary>
        /// <param name="id"></param>
        /// <returns>StatusCode</returns>
        [HttpGet("{id}")]
        ...
        /// <summary>
        /// Create a event in the calendar. Deploy a code 201(CREATED), refers to an envent created, or an error 400(BAD REQUEST) refers to a not
        /// </summary>
